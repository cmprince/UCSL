...
The only remaining uncertainty is how to treat the standard deviation *s*. Literature indicates various corrections that can be made to estimate the variance of a sample median, but as we shall see below, such a correction would have to be enormous to have an impact.
