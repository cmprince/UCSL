...
The only remaining uncertainty is how to adjust the standard deviation *s*.^[The value for the variance of a sample median cited in various online sources is $$s^2 = \frac{1}{4nf(\tilde{\mu})^2}$$. ] But as we shall see below, any such correction would have to be enormous to have an impact on the outcome of the test.
