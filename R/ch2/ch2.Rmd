...
Since the t-statistic is less than the negative critical value, we reject the null hypothesis that the median for overtime is 2 hours. The p-value is `r round(pt(t2,df=n_ot-1),1)`.
